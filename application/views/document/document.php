            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?= base_url('Setup_document/tamdoc') ?>" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Add Data Document</a>
                        <a href="<?= base_url('server/save'); ?>" class="btn btn-info mb-3"><i class="fas fa-save"></i> SaveDc</a>
                        <div class="table table-responsive">
                            <table id="dataTable" class="table">
                                <thead>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu ">
                                                        <li><button class="dropdown-item btn-edit" data-toggle="modal" data-target="#NewDocumenttEditModal<?= $dc['id']; ?>"><i class="bi bi-pencil-square"></i>Edit</button></li>
