            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url() ?>setupPengeluaran/updatekategori" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                    <input type="hidden" value="<?= $kategori['id'] ?>" name="id" id="id">
                                    <div class="form-group">
                                        <label for="kategori" class="form-label">Kategori</label>
                                        <input type="text" class="form-control" name="kategori" value="<?= $kategori['name_kategori'] ?>" id="kategori" placeholder="kategori">
                                    </div>
                                </div>
                            </div>
